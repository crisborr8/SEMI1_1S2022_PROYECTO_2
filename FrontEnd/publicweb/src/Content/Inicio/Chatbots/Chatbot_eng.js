...
class Chatbot_eng extends Component {
  constructor(props){
        super(props);
        this.state = {
            mensajes: []
  ...
  componentDidMount(){
    var msj = [
      ...
      },
      {
        ...
        mensaje: 'Message number 1 from the bot sended to the final user ja ja ja'
      },
      {
        class: 'chat__conversation-board__message-container',
        foto: 'https://www.nicepng.com/png/detail/13-136710_anonymous-browsing-user.png',
      ...
      },
      {
        class: 'chat__conversation-board__message-container reversed',
        foto: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQwcFaQjC7naERCbOviYjMqb8m8r27STidFUE_OL2lC1dGpEos34SN7mZpqDzLz91wOS1A&usqp=CAU',
        mensaje: 'Message number 2 from the final user sended to the bot ja ja ja'
      }
    ]
        ...
        <div class="--dark-theme" id="chat">
          ...
          <div class="chat__conversation-panel">
            <div class="chat__conversation-panel__container">
              <input class="chat__conversation-panel__input panel-item" placeholder="Write your message..."/>
